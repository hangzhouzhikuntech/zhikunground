...
QGCApplication::QGCApplication(int &argc, char* argv[], bool unitTesting)
    ...
    , _lastKnownHomePosition(30.3437457, 120.090664, 0.0)
    ,_speechControlMode(false)
{
    Q_ASSERT(_app == NULL);
    _app = this;
    ...
    _lastKnownHomePosition.setLatitude(settings.value(_lastKnownHomePositionLatKey, 30.3437457).toDouble());
    _lastKnownHomePosition.setLongitude(settings.value(_lastKnownHomePositionLonKey, 120.090664).toDouble());
...
void QGCApplication::_initCommon(void)
{
    ...
    qmlRegisterType<ExternalDeviceComponent>            ("QGroundControl.Controllers", 1, 0, "ExternalDeviceComponent");
    ...
    //_toolbox->audioOutput()->say(QString("huan ying shi yong hang zhou zhi kun ke ji you xian gong si di mian zhan xi tong"), GAudioOutput::AUDIO_SEVERITY_NOTICE);
    /*QSound *pSound = new QSound(QString("/home/zhitong/qgroundcontrol/tips/test.wav"));
    pSound->play();
    ...
    /*QGCAsrWorker *asrWorker = new QGCAsrWorker();
    asrWorker->init();*/
...
void QGCApplication::_setSpeechControlMode(bool modFlag)
{
    _speechControlMode = modFlag;
}
bool QGCApplication::_getSpeechControlMode(void)
{
