...
public:
    ...
    /*add by xuzhitong*/
    /*control the external device on police plane*/
    enum StartExternalDeviceType{
        StartExternalDeviceCloseAlarmLight,
        StartExternalDeviceOpenAlarmLight,
        StartExternalDeviceGimbalStart,
        StartExternalDeviceGimbalAdjust,
        StartExternalDeviceGimbalStop
    };
    ...
    /*add by xuzhitong*/
    virtual void controlExternalDevices(StartExternalDeviceType extType,qint32 * params=NULL) = 0;
