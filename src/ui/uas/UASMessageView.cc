    ...
    , _pauseFlag(false)
{
    ...
    connect(pauseAction, &QAction::triggered, this, &UASMessageViewWidget::pauseMessages);
    ui()->plainTextEdit->addAction(clearAction);
    ui()->plainTextEdit->addAction(pauseAction);
...
void UASMessageViewWidget::pauseMessages()
{
     _pauseFlag = !_pauseFlag;
    if (_pauseFlag)
    {
        disconnect(_uasMessageHandler, &UASMessageHandler::textMessageReceived, this, &UASMessageViewWidget::handleTextMessage);
    }
    else
    {
        connect(_uasMessageHandler, &UASMessageHandler::textMessageReceived, this, &UASMessageViewWidget::handleTextMessage);
