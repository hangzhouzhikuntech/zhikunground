...
QGCView {
    ...
    readonly property var       _defaultVehicleCoordinate:   QtPositioning.coordinate(120.090840, 30.345027) 
            ...
            FlightMap {
                ...
                Column {
                   ...
                   DropButton {
                        id:                 alarmLightButton
                        dropDirection:      dropRight
                        buttonImage:        "/qmlimages/AlarmLight.svg"
                        viewportMargins:    ScreenTools.defaultFontPixelWidth / 2
                        exclusiveGroup:     _dropButtonsExclusiveGroup
                        z:                  QGroundControl.zOrderWidgets
                                ...
                                Row {
                                    spacing: ScreenTools.defaultFontPixelWidth                                 
                                        ...
                                        QGCButton {
                                            ...
                                            onClicked: {
                                                checked = true;
                                                extcontroller.controlExternalDevices(0);
                                            }
                                          }
                                        ...
                                        QGCButton {
                                            ...
                                            onClicked: {
                                               extcontroller.controlExternalDevices(1);
                                                checked = true
                                                //mapTypeButton.hideDropDown()
                                            }
